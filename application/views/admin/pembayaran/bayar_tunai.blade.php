                ...
                <div class="card">
                    <div class="pembayaran">
                        <div>
                            <center>
                                <strong>
                                    <h4 style="font-weight: bold">Transaksi Tunai</h4>
                                </strong>
                            </center>
                        </div>
                    <form action="{{ base_url('index.php/admin/pembayaran/transaksi') }}" method="post">
                        <input type="text" name="metode" value="2" hidden>
                ...
                <div class="card">
                    <div class="pembayaran">
                        <div>
                            <center>
                                <strong>
                                    <h4 style="font-weight: bold">Pembayaran Tunai</h4>
                                </strong>
                            </center>
                        </div>
                        <form action="{{ base_url('index.php/admin/pembayaran/bayar_tunai') }}" method="post">
                            <strong>Konsumen:</strong> <br><input type="text" class="input" name="konsumen" placeholder="Ketik id konsumen" required><br>
                            <strong>Kode Item: </strong> <br><input type="text" class="input" name="kode_item" placeholder="Ketik kode item" required><br>
